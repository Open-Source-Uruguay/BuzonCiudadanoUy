  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: Column(
        ...
        children: [locationSection(), reportSection()],
      ),
    ));
  }
  ...
  Container locationSection() {
    return Container(
        ...
        decoration: const BoxDecoration(
          ...
          bottom: BorderSide(width: 0.50, color: Color(0xFFDFDFDF)),
        )),
        child: const Row(
            mainAxisSize: MainAxisSize.min,
            mainAxisAlignment: MainAxisAlignment.start,
  ...
  BottomNavigationBar navigationBar() {
    return BottomNavigationBar(
      items: const [
        ...
        BottomNavigationBarItem(
            icon: Icon(Icons.content_paste_outlined), label: 'Reportes'),
        BottomNavigationBarItem(
...
class ReportCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 150,
      height: 150,
      padding: const EdgeInsets.only(top: 16, left: 16, right: 16, bottom: 114),
      decoration: ShapeDecoration(
          shape: RoundedRectangleBorder(
              side: const BorderSide(width: 0.75, color: Color(0xFFDFDFDF)),
